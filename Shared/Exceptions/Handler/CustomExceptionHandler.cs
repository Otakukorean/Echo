...
public class CustomExceptionHandler(ILogger<CustomExceptionHandler> logger) : IExceptionHandler
{
    public async ValueTask<bool> TryHandleAsync(HttpContext httpContext, Exception exception, CancellationToken cancellationToken)
    {
        ...
        {
            UnauthorizedException => (exception.Message , exception.GetType().Name , httpContext.Response.StatusCode = StatusCodes.Status401Unauthorized),
            ...
            NotFoundException => ("Not Found" , "Not Found" , httpContext.Response.StatusCode =  StatusCodes.Status404NotFound),
            ...
            _ => ("Internal Server Error" , "Internal Server Error" , httpContext.Response.StatusCode =  StatusCodes.Status500InternalServerError)
        };
